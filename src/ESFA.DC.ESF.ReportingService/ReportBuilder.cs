...
namespace ESFA.DC.ESF.ReportingService
{
    public class ReportBuilder
    {
        public static List<FundingReportRow> FundingModelDeliverables = new List<FundingReportRow>
        {
            ...
            new FundingReportRow { RowType = RowType.Header, Title= "Regulated Learning" },
            new FundingReportRow { CodeBase = "ILR", DeliverableCode = "RQ01", RowType = RowType.Data, Title = "ILR RQ01 Regulated Learning - Start Funding (£)" },
            new FundingReportRow { CodeBase = "ILR", DeliverableCode = "RQ01", RowType = RowType.Data, Title = "ILR RQ01 Regulated Learning - Achievement Funding (£)" },
            new FundingReportRow { CodeBase = "ILR", DeliverableCode = "RQ01", RowType = RowType.Total, Title = "ILR Total RQ01 Regulated Learning (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "RQ01", RowType = RowType.Data, Title = "SUPPDATA RQ01 Regulated Learning Audit Adjustments (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "RQ01", RowType = RowType.Data, Title = "SUPPDATA RQ01 Regulated Learning Authorised Claims (£)" },
            ...
            new FundingReportRow { RowType = RowType.Header, Title= "Non Regulated Activity" },
            new FundingReportRow { CodeBase = "ILR", DeliverableCode = "NR01", RowType = RowType.Data, Title = "ILR NR01 Non Regulated Activity - Start Funding (£)" },
            new FundingReportRow { CodeBase = "ILR", DeliverableCode = "NR01", RowType = RowType.Data, Title = "ILR NR01 Non Regulated Activity - Achievement Funding (£)" },
            new FundingReportRow { CodeBase = "ILR", DeliverableCode = "NR01", RowType = RowType.Total, Title = "ILR Total NR01 Non Regulated Activity (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "NR01", RowType = RowType.Data, Title = "SUPPDATA NR01 Non Regulated Activity Audit Adjustments (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "NR01", RowType = RowType.Data, Title = "SUPPDATA NR01 Non Regulated Activity Authorised Claims (£)" },
            ...
            new FundingReportRow { RowType = RowType.Header, Title= "Additional Programme Cost" },
            ...
            new FundingReportRow { RowType = RowType.Header, Title= "Progression and Sustained Progression" },
            ...
            new FundingReportRow { RowType = RowType.Header, Title= "Actual Costs" },
            ...
            new FundingReportRow { RowType = RowType.Header, Title= "Community Grant" },
            ...
            new FundingReportRow { RowType = RowType.Header, Title= "Specification Defined" },
            ...
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "SD04", RowType = RowType.Data, Title = "SUPPDATA SD04 <a description of the deliverable from FCS> (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "SD05", RowType = RowType.Data, Title = "SUPPDATA SD05 <a description of the deliverable from FCS> (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "SD06", RowType = RowType.Data, Title = "SUPPDATA SD06 <a description of the deliverable from FCS> (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "SD07", RowType = RowType.Data, Title = "SUPPDATA SD07 <a description of the deliverable from FCS> (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "SD08", RowType = RowType.Data, Title = "SUPPDATA SD08 <a description of the deliverable from FCS> (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "SD09", RowType = RowType.Data, Title = "SUPPDATA SD09 <a description of the deliverable from FCS> (£)" },
            new FundingReportRow { CodeBase = "ESF", DeliverableCode = "SD10", RowType = RowType.Data, Title = "SUPPDATA SD10 <a description of the deliverable from FCS> (£)" },
