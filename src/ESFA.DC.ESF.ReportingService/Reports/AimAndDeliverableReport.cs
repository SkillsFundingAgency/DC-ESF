            ...
            foreach (var learner in learners)
            {
                ...
                foreach (var delivery in deliveries)
                {
                    var fm70Delivery = fm70learningDeliveries?.SingleOrDefault(d =>
                        d.LearnRefNumber == learner.LearnRefNumber && d.AimSeqNumber == delivery.AimSeqNumber);
                    ...
                    var fm70Period = fm70DeliverablePeriods.SingleOrDefault(p =>
                    ...
                    var reportModel = new AimAndDeliverableModel
                    {
                        ...
                        Period = fm70Period?.Period,
                        DeliverableVolume = fm70Period?.DeliverableVolume,
                        StartEarnings = fm70Period?.StartEarnings,
                        AchievementEarnings = fm70Period?.AchievementEarnings,
                        AdditionalProgCostEarnings = fm70Period?.AdditionalProgCostEarnings,
                        ProgressionEarnings = fm70Period?.ProgressionEarnings,
                        TotalEarnings = fm70Period?.StartEarnings ?? 0 + fm70Period?.AchievementEarnings ?? 0
                                        + fm70Period?.AdditionalProgCostEarnings ?? 0 + fm70Period?.ProgressionEarnings ?? 0
                    };
